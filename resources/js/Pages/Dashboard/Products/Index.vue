        ...
        <dash-layout>
            <div class="px-4 py-2">
                <div class="flex justify-between mb-3">
                    ...
                    <inertia-link :href="route('products.create')" class="py-1 px-2 shadow-md bg-blue-600 rounded">Add new</inertia-link>
                </div>
                            ...
                            <tr v-for="product in products" :key="product.id">
                                ...
                                <td class="border p-1">
                                    <div class="flex justify-around">
                                        <inertia-link :href="route('products.edit',product.id)" class="bg-green-300 hover:bg-green-200 py-1 px-2 rounded shadow-md">Edit</inertia-link>
                                        <inertia-link :href="route('products.destroy',product.id)" method="delete" class="bg-red-300 hover:bg-red-200 py-1 px-2 rounded shadow-md">Delete</inertia-link>
                                    </div>
                                </td>
                            </tr>
                        </template>
